...
<Exercise number="1.1">
Prove that in any group $G$, the equation $ax = b$ has a unique solution for any $a, b \in G$.
</Exercise>

<Exercise number="1.2">
Let $G$ be a group in which $a^2 = e$ for all $a \in G$. Prove that $G$ is abelian.
</Exercise>

<Exercise number="1.3">
Prove that $(\mathbb{Q}^*, \cdot)$ is not cyclic.
</Exercise>

<Exercise number="1.4">
Let $\phi : G \to H$ be a group homomorphism. Prove that if $G$ is abelian, then $\text{im}(\phi)$ is abelian.
</Exercise>

<Exercise number="1.5">
Determine all subgroups of $\mathbb{Z}/12\mathbb{Z}$ and draw the subgroup lattice.
</Exercise>
...
<ProblemLink
  subject="mathematics"
  field="abstract-algebra"
  problemId="group-axioms-1"
  title="Verify the group axioms for matrix groups"
  difficulty="medium"
/>
...
<ProblemLink
  subject="mathematics"
  field="abstract-algebra"
  problemId="homomorphism-1"
  title="Determine the kernel and image of a homomorphism"
  difficulty="medium"
/>
...
<ProblemLink
  ...
  field="abstract-algebra"
  problemId="cyclic-1"
  title="Find all generators of a cyclic group"
  difficulty="easy"
/>
